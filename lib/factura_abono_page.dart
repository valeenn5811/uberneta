...
class FacturaAbonoPage extends StatefulWidget {
  final String id;
  final String dni;
  final String nombre;
  final String correo;
  ...
  @override
  _FacturaAbonoPageState createState() => _FacturaAbonoPageState();
}

class _FacturaAbonoPageState extends State<FacturaAbonoPage> {
  ...
  // Función para obtener la razón social desde el servidor
  Future<void> _obtenerRazonSocial(String dni) async {
    if (dni.isEmpty || dni.length < 9) {
      // Ocultar el campo si el DNI no es válido
      setState(() {
  ...
  // Función para obtener el idCliente desde el servidor
      ...
      final response = await http
          .post(
            ...
            body: {
              ...
              'subject': 'Abono - Factura ${facturaInfo['NumeroFactura']}',
              'text': 'Adjunto encontraras la factura del abono.',
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.receipt, color: Color(0xFFA42429), size: 32),
                        SizedBox(width: 12),
                        Text(
                          'Factura Abono',
                          style: TextStyle(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              onChanged: (value) {
                                ...
                                _precioController
                                  ...
                                  TextPosition(
                                    offset: _precioController.text.length,
                                  ),
                                );
                              },
                            ),
                            ...
                            Center(
                              child: ElevatedButton(
                                ...
                                child: const Text('Guardar y Generar Factura'),
                              ),
                            ),
                          ],
                        ),
